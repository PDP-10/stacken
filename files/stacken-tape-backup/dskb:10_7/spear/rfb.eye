...
!++
!
!  microcode loaded event (code 073, tops10)
!
!--
RFB TOPS10
 073 UC_LOADED
  UC_CODE		1	12-17	! LOAD ERROR CODE
  UC_OFFSET		1	18-35	! OFFSET INTO BOOTSTRAP VECTOR
  UC_DEV		2	0-17	! DEVICE CODE
  UC_UNIT		2	18-35	! UNIT NUMBER
  UC_INTER		3	0-35	! SIXBIT INTERFACE NAME
  UC_CHAN		4	0-35	! SIXBIT CHANNEL NAME
  UC_MVR		5	0-35	! MINIMUM UCODE VERSION
  UC_DTM		6	0-35	! DATE-TIME OF LOAD
  UC_VER		7	0-35	! UCODE VERSION LOADED
END RFB

WORD_10 TOPS10 
 UC_CODE
   $CTR_UC_CODE			12-17
				\V   1 'Loading Disabled'
				\V   2 'No Code Available'
				\V   3 'Wrong Version'
				\V   4 'Load Error'
				\V   5 'Verify Error'
				\V   6 'Microprocessor Check'
				\V   7 'CRAM Load Error'
				\V   8 'CRAM Verify Error'
				\V   9 'DRAM Load Error'
				\V   10 'DRAM Verify Error'
END WORD_10

!++
!	The following is writen by TOPS-10 when it detects
!	a software detected error in the disk subsystem such as a checksum
!	failure or RIB error
!--
RFB TOPS10
 074	SFTWR_DISK_ERROR
  SOF_NAME		1	0-35	! SIXBIT UNIT NAME
  SOF_PACK		2	0-35	! SIXBIT PACK ID(HOME BLOCK)
  SOF_STR		3	0-35	! SIXBIT STRUCTURE NAME
  SOF_LBN		4	0-35	! LBN
  SOF_RETRY		5	18-35	! RETRY COUNT
  SOF_CN1		6	0-35	! 1ST SET OF SOFTWARE COUNTS
  SOF_CN2		7	0-35	! 2ND
  SOF_CN3		8	0-35	! 3RD
  SOF_FILE		9	0-35	! SIXBIT FILE NAME
  SOF_EXT		10 	0-35	!   "      "  EXTENSION
  SOF_PPN		11	0-35	! P,PN
  SOF_PGM		12	0-35	! SIXBIT PROGRAM NAME
  SOF_CODE		13	0-35	! SOFTWARE ERROR CODE
END RFB
